...
public interface LockExecutor {
     ...
     * @throws Exception
     */
    boolean acquire(String lockKey, String lockValue, long acquireExpire, long waitTime, boolean ifFairLock, TimeUnit timeUnit);
     ...
     * @return 是否释放成功
     */
    boolean releaseLock( LockInfo lockInfo, boolean ifFairLock);
}
