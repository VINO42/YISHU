 ...
 * 6.若您的项目无法满足以上几点，可申请商业授权
 */
package io.github.vino42.minio.configuration;

import io.github.vino42.minio.core.MinioAsyncClientObjectPool;
import io.github.vino42.minio.core.MinioClientObjectPool;
...
public class MinioConfiguration {
    ...
    public MinioClientObjectPool minioClientPool(MinioProperties minioProperties) {
        ...
        log.trace("[YISHU] |- Bean [Minio Client Pool] Auto Configure.");
    ...
    public MinioAsyncClientObjectPool minioAsyncClientPool(MinioProperties minioProperties) {
        ...
        log.trace("[YISHU] |- Bean [Minio Async Client Pool] Auto Configure.");
    ...
    static class MinioLogicConfiguration {
        @PostConstruct
        public void init() {
            log.debug("[YISHU] |- SDK [Engine Oss Minio Logic] Auto Configure.");
        }
    }
}
