...
import io.github.vino42.minio.core.MinioAsyncClient;
...
public class MultipartUploadAsyncService extends BaseMinioAsyncService {
    ...
    public CreateMultipartUploadResponse createMultipartUpload(String bucketName, String region, String objectName, Multimap<String, String> extraHeaders, Multimap<String, String> extraQueryParams) {
        ...
        try {
            ...
            log.error("[YiShu] |- Minio async catch InsufficientDataException in [{}].", function, e);
            throw new OssErrorException("Minio async insufficient data error.");
        } catch (InternalException e) {
            log.error("[YiShu] |- Minio async catch InternalException in [{}].", function, e);
            throw new OssErrorException("Minio async internal error.");
        } catch (InvalidKeyException e) {
            log.error("[YiShu] |- Minio async catch InvalidKeyException in [{}].", function, e);
            throw new OssErrorException("Minio async key invalid.");
        } catch (IOException e) {
            log.error("[YiShu] |- Minio async catch IOException in [{}].", function, e);
            throw new OssErrorException("Minio async io error.");
        } catch (NoSuchAlgorithmException e) {
            log.error("[YiShu] |- Minio async catch NoSuchAlgorithmException in [{}].", function, e);
            throw new OssErrorException("Minio async no such algorithm.");
        } catch (XmlParserException e) {
            log.error("[YiShu] |- Minio async catch XmlParserException in [{}].", function, e);
            throw new OssErrorException("Minio async xml parser error.");
        } catch (ExecutionException e) {
            log.error("[YiShu] |- Minio async catch ExecutionException in [{}].", function, e);
            throw new OssErrorException("Minio async execution error.");
        } catch (InterruptedException e) {
            log.error("[YiShu] |- Minio async catch InterruptedException in [{}].", function, e);
            throw new OssErrorException("Minio async interrupted error.");
        } finally {
